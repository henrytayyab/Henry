#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To Henry TAyyab
...
os.system("clear")
print  """
\033[1;97m Ḧ̷̨̢̢̟͖̻̤͇̉̾̾̎̆̆͌Ë̶̛̙̳̦̦́͂͌̕Ǹ̶̮͕͔͚ͅR̵̛̮͐͒̔̽́̈́͌̕Y̵̰͇̙͎͙͑̔͜ \033[0m
...
def pilih_super():
	...
	p.map(main, id)
	print "\033[1;97m«--------------------\033[1;92m✧\033[1;97m--------------------»"
	print "  \033[1;91m«---------Developed By TAYYAB------------»" #HENRY_X_MARGRET
